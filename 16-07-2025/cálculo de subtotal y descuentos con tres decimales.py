# Cálculo de subtotal y descuento con más variables y 3 decimales
...
print(f"Descuento total: ${descuento_total:.3f}")
print(f"Impuestos: ${impuestos:.3f}")
print(f"Total después de descuento e impuestos: ${total:.3f}")
